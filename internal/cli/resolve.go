...
func resolveCommandWithInput(ctx context.Context, args []string, stdin io.Reader, interactive bool, stdout, stderr io.Writer) error {
	...
	flags.Usage = func() {
		...
		fmt.Fprintln(stderr, "an incomplete leased Run, retire owned artifacts, remove managed active")
		fmt.Fprintln(stderr, "and Candidate labels, preserve diagnostics, and release the Lease.")
