...
- Conclusively absent branches, worktrees, and active sessions are already retired. Already archived sessions are also satisfied. Changed, mismatched, or unknown artifacts stop resolution with the Lease retained for an incomplete Run, or with Historical Completion metadata unchanged for a merged Run.
